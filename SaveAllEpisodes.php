            ...
            <div class="CoverPageDataDiv">
                <div class="CoverPageDataSubDiv" style="border:30px solid '.$ThemeColor.';">
                    <h1 class="TitleHeading">'.$title.'</h1>
                     <h2>ACTORS:</h2>
                     <p class="SmallDescription">'.$actor1.' </p>
                     <p class="SmallDescription">'.$actor2.' </p>
                     <br>
                     <br>
                     <br>
...
$sql="INSERT INTO `upload_data` (`id`, `title`, `type`, `img_cover`, `location`) VALUES (NULL, '".$Title."', 'ANIME', '".$ImageLinkUpload."', '".$kk."');";
